...
String typo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (extras != null) {
            jsonMyObject = extras.getString("Groups");
        }
        ...
        if(myObject.getName()!=null) {
            ...
            ListView listView = (ListView) view.findViewById(R.id.groups_content);
            listViewonclick = (ListView) view.findViewById(R.id.groups_content);
