...
public class OneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "Extras are" + extras.getString("typo")+ "]");
        ...
        if(myObject.getName()!=null) {
            ...
            listViewonclick = (ListView) view.findViewById(R.id.users_content);
                        ...
                        protected String doInBackground(Void... params) {
                            ...
                            try {
                                ...
                                result = response1.body().string();
                                 Log.d(TAG, "bitch" +"http://sample-env.7aw77efvjh.us-west-2.elasticbeanstalk.com/?url=" + myObject.getNext() + "&selType=paginate + ");
                                //  gson=new Gson();
            ...
            String typo = extras.getString("typo");
