...
public class events extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            temp = (ArrayList<ToPass>) ObjectSerializer.deserialize(sharedPreferences.getString("event", ObjectSerializer.serialize(new ArrayList<ToPass>())));
        } catch (Exception e) {
            e.printStackTrace();
        }
        if(temp!=null) {
            ...
            customAdapter = new favadaptor(this.getContext(), name, profile_pic, id, "event");
