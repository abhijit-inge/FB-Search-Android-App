...
public class places extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            temp = (ArrayList<ToPass>) ObjectSerializer.deserialize(sharedPreferences.getString("places", ObjectSerializer.serialize(new ArrayList<ToPass>())));
        } catch (Exception e) {
            e.printStackTrace();
        }
        if(temp!=null) {
            ...
            customAdapter = new favadaptor(this.getContext(), name, profile_pic, id, "places");
