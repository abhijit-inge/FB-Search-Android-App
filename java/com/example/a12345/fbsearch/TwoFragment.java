...
public class TwoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (extras != null) {
            jsonMyObject = extras.getString("Pages");
        ...
        if(myObject.getName()!=null) {
           ...
           // myObject = new Gson().fromJson(jsonMyObject, Response.class);
            ...
            ListView listView = (ListView) view.findViewById(R.id.pages_content);
            listViewonclick = (ListView) view.findViewById(R.id.pages_content);
